  ...
  return (
    <div className='p-3 h-[10vh]'>
      ...
      <div className="searchBar flex justify-center items-center space-x-3">
        <div className=''><IoMdHome className='size-8' /></div>
      
      <input className='bg-gray-600 rounded-2xl px-20 py-1' type="text" name="" id="" />
      </div>
      <div className="btns flex justify-center items-center space-x-3">
        ...
        <a href="#">
                <button className='bg-white text-black text-lg font-semibold rounded-2xl px-3'>SignUp</button>
            </a>
        </div>
      </div>
      </nav>
